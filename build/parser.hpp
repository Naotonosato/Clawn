...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    OP_NOT_EQUAL = 270,            // OP_NOT_EQUAL
    OP_MORE_EQUAL = 271,           // OP_MORE_EQUAL
    OP_LESS_EQUAL = 272,           // OP_LESS_EQUAL
    OP_MORE = 273,                 // OP_MORE
    OP_LESS = 274,                 // OP_LESS
    PLUS = 275,                    // PLUS
    MINUS = 276,                   // MINUS
    ...
    LEFT_CURLY_BRACE = 283,        // LEFT_CURLY_BRACE
    RIGHT_CURLY_BRACE = 284,       // RIGHT_CURLY_BRACE
    LEFT_PARENTHESIS = 285,        // LEFT_PARENTHESIS
    RIGHT_PARENTHESIS = 286,       // RIGHT_PARENTHESIS
    LEFT_PARENTHESIS_AND_EOL = 287, // LEFT_PARENTHESIS_AND_EOL
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_OP_AND = 12,                           // OP_AND
        S_OP_OR = 13,                            // OP_OR
        S_OP_EQUAL = 14,                         // OP_EQUAL
        S_OP_NOT_EQUAL = 15,                     // OP_NOT_EQUAL
        S_OP_MORE_EQUAL = 16,                    // OP_MORE_EQUAL
        S_OP_LESS_EQUAL = 17,                    // OP_LESS_EQUAL
        S_OP_MORE = 18,                          // OP_MORE
        S_OP_LESS = 19,                          // OP_LESS
        S_PLUS = 20,                             // PLUS
        S_MINUS = 21,                            // MINUS
        S_ASTERISK = 22,                         // ASTERISK
        S_SLASH = 23,                            // SLASH
        S_UMINUS = 24,                           // UMINUS
        S_SEMICOLON = 25,                        // SEMICOLON
        S_LEFT_BRACKET = 26,                     // LEFT_BRACKET
        S_RIGHT_BRACKET = 27,                    // RIGHT_BRACKET
        S_LEFT_CURLY_BRACE = 28,                 // LEFT_CURLY_BRACE
        S_RIGHT_CURLY_BRACE = 29,                // RIGHT_CURLY_BRACE
        S_LEFT_PARENTHESIS = 30,                 // LEFT_PARENTHESIS
        S_RIGHT_PARENTHESIS = 31,                // RIGHT_PARENTHESIS
        S_LEFT_PARENTHESIS_AND_EOL = 32,         // LEFT_PARENTHESIS_AND_EOL
